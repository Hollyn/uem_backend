...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'abbreviation' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-05-27 12:56:21',
                'modified' => '2019-05-27 12:56:21'
            ],
        ];
        parent::init();
    }
