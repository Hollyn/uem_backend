...
class EngagementsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'engagement' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'event_id' => 1,
                'created' => '2019-05-27 10:49:37',
                'modified' => '2019-05-27 10:49:37'
            ],
        ];
        parent::init();
    }
