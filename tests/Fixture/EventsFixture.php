...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'photo_path' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date' => '2019-09-22',
                'startTime' => '2019-09-22 16:30:05',
                'endTime' => '2019-09-22 16:30:05',
                'status' => 1,
                'photo_path' => 'Lorem ipsum d',
                'user_id' => 1,
                'created' => '2019-09-22 16:30:05',
                'modified' => '2019-09-22 16:30:05'
            ],
        ];
        parent::init();
    }
