...
class GroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'groups_ibfk_1' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['users', 'group_id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-05-27 10:52:26',
                'modified' => '2019-05-27 10:52:26'
            ],
        ];
        parent::init();
    }
