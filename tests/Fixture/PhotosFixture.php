...
class PhotosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'photos_ibfk_1' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['events', 'photo_id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-05-27 10:51:50',
                'modified' => '2019-05-27 10:51:50'
            ],
        ];
        parent::init();
    }
